...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/newdaychurchnashville.org/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/newdaychurchnashville.org/fullchain.pem', 'utf8');
