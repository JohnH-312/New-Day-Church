...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/newdaychurchnashville.com/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/newdaychurchnashville.com/fullchain.pem', 'utf8');
